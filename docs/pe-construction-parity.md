...
| Donor-survey source-impute predictor contract | [`us.py`](/Users/maxghenis/CosilicoAI/microplex-us/src/microplex_us/pipelines/us.py), [`pe_us_data_rebuild.py`](/Users/maxghenis/CosilicoAI/microplex-us/src/microplex_us/pipelines/pe_us_data_rebuild.py) | [`source_impute.py`](/Users/maxghenis/PolicyEngine/policyengine-us-data/policyengine_us_data/calibration/source_impute.py) | `Compatible, not equivalent` | Microplex now has an explicit `pe_prespecified` donor-condition mode that mirrors PE's fixed ACS/SIPP/SCF predictor surfaces when those donor sources are present. The actual donor-source adapters and full source-imputation stage are still not rebuilt end to end. |
