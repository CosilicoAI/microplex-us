...
| Donor-survey source-impute predictor contract | [`us.py`](/Users/maxghenis/CosilicoAI/microplex-us/src/microplex_us/pipelines/us.py), [`pe_us_data_rebuild.py`](/Users/maxghenis/CosilicoAI/microplex-us/src/microplex_us/pipelines/pe_us_data_rebuild.py), [`donor_surveys.py`](/Users/maxghenis/CosilicoAI/microplex-us/src/microplex_us/data_sources/donor_surveys.py) | [`source_impute.py`](/Users/maxghenis/PolicyEngine/policyengine-us-data/policyengine_us_data/calibration/source_impute.py) | `Compatible, not equivalent` | Microplex now has an explicit `pe_prespecified` donor-condition mode plus opt-in ACS/SIPP/SCF donor-survey adapters aligned to the PE source-impute inputs. The full source-imputation stage is still not a line-by-line PE clone, especially around annualization/sampling details and how generic donor integration replaces the PE inline script. |
...
4. Several family constructions and donor-source adapters still need a real
   audit before we can call them PE-equivalent.
